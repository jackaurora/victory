...
<aside id="menu" class="sidebar">
   <ul class="nav metis-menu" id="side-menu" style="background-color:#2048b9">
      <li style="color: #cabdff" class="dashboard_user<?php if($totalQuickActionsRemoved == count($quickActions)){echo ' dashboard-user-no-qa';}?>">
      ...
      <li class="menu-item-<?php echo $item['slug']; ?>"
         ...
         <a href="<?php echo count($item['children']) > 0 ? '#' : $item['href']; ?>"
          ...
          <?php echo _attributes_to_string(isset($item['href_attributes']) ? $item['href_attributes'] : []); ?>>
             ...
             <span class="menu-text" style="color: #a9ffef">
