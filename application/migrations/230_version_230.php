...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/victory/scripts.php')) {
            @unlink(VIEWPATH . 'themes/victory/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'victory') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/victory/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
