...
class Migration_Version_250 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if ($theme != 'victory') {
            @copy(APPPATH . 'views/themes/victory/template_parts/contracts_table.php', APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contracts_table.php');

            @copy(APPPATH . 'views/themes/victory/template_parts/projects/project_contracts.php', APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/projects/project_contracts.php');
        }
