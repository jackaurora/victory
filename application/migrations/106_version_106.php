...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'victory'){
            copy(APPPATH . 'views/themes/victory/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
