module.exports = function(grunt) {
    ...
    let gruntConfig = {
        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/themes/victory/js/clients.min.js': ['assets/themes/victory/js/clients.js'],
                    'assets/themes/victory/js/global.min.js': ['assets/themes/victory/js/global.js'],
        ...
        cssmin: {
            target: {
                files: [{
                        src: ['assets/themes/victory/css/style.css'],
                        dest: 'assets/themes/victory/css/style.min.css',
                        ext: '.min.css'
                    },
                    {
        ...
        postcss: {
            ...
            dist: {
                src: [
                    'assets/css/*.css',
                    '!assets/css/*.min.css',
                    'assets/themes/victory/css/*.css',
                    '!assets/themes/victory/css/*.min.css',
                ]
            }
        },
        concat: {
        ...
        header: {
            dist: {
                ...
                files: {
                    ...
                    'assets/themes/victory/js/clients.min.js': 'assets/themes/victory/js/clients.min.js',
                    'assets/themes/victory/js/global.min.js': 'assets/themes/victory/js/global.min.js',
                }
            }
        },
    }
