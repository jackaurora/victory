            ...
            foreach ($theme_style as $applied_style) {
                if ($applied_style->id == $_area['id']) {
                    ...
                    if (startsWith($_area['target'], '.btn')) {
                        ...
                        ' . $_area['target'] . ':active,
                        ' . $_area['target'] . '.active,
                        .open > .dropdown-toggle' . $_area['target'] . '{background-color:' . adjust_color_brightness($applied_style->color, -50) . ';color:#89d4ff;border-color:' . adjust_color_brightness($applied_style->color, -50) . '}';
                        echo '
                        ...
                        ' . $_area['target'] . '[disabled].active,
                        fieldset[disabled] ' . $_area['target'] . '.active {
                            background-color: ' . adjust_color_brightness($applied_style->color, 50) . ';color:#89d4ff;border-color:' . adjust_color_brightness($applied_style->color, 50) . ';}';
                    }
